...
{
    public partial class GestionActeur : Form
    {
        public int IdActeurCree { get; private set; } // <-- Propriété publique
        public GestionActeur()
        {
            InitializeComponent();
        }
        ...
        private void btnEnregistrer_Click(object sender, EventArgs e)
        {
            ...
            using (var conn = DbConnectionHelper.GetConnection())
            {
                ...
                using (var cmd = new SqlCommand(sql, conn))
                {
                    ...
                    IdActeurCree = (int)cmd.ExecuteScalar();
                }
            }
